//
//  BrinDemoSilverMasterViewController.m
//  BrintDemo
//
...
#import "BrinDemoSilverMasterViewController.h"
#import "BrinDemoSilverListViewController.h"

@interface BrinDemoSilverMasterViewController ()
@property (nonatomic, retain) NSMutableArray *diamondCategoryListArray;
@end

@implementation BrinDemoSilverMasterViewController
...
- (void)prepareForSegue:(UIStoryboardSegue *)segue sender:(id)sender
{
    ...
    BrinDemoSilverListViewController *goldListViewController = (BrinDemoSilverListViewController*)segue.destinationViewController;
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    [self performSegueWithIdentifier: @"SilverList" sender: self];
}
